...
PageLayouts["CityState" ] = function(page)
	...
	--[[local types = {
		...
		["CVS_LEADER_MINOR_CIV_MARITIME"] = {"ICON_CVS_CITYSTATE_MARITIME", "LOC_CITY_STATES_TYPE_CVS_MARITIME", "CVS_COLOR_PLAYER_CITY_STATE_MARITIME_SECONDARY"},
	}]]
	local types = {}
	for k, v in pairs(tCityStateTypes) do
		types[v.LeaderType] = {v.TypeIcon, v.TypeName, v.SecondaryColor}
	end
	-- /C15 --
	local cityStateType;
